...
HD_PWD='D:/ECE385_final_project_Final/ECE385_final_project.runs/mb_block_hdmi_graph_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_hdmi_graph_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_hdmi_graph_controller_0_0.tcl
