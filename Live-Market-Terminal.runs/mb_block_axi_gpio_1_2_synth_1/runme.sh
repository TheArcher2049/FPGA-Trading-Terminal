...
HD_PWD='C:/FPGA/ECE385_final_project/ECE385_final_project.runs/mb_block_axi_gpio_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_axi_gpio_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_axi_gpio_1_2.tcl
