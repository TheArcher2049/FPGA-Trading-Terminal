...
(
    ...
    output logic [31:0] profit_reg_0, // NEW
    output logic [31:0] profit_reg_1, // NEW
    ...
    logic [31:0] slv_reg_profit0, slv_reg_profit1; // NEW
    ...
    assign profit_reg_0 = slv_reg_profit0; // NEW
    assign profit_reg_1 = slv_reg_profit1; // NEW
    ...
    always_ff @(posedge S_AXI_ACLK) begin
        if (~S_AXI_ARESETN) begin
            ...
            slv_reg_avg0        <= 32'd0;
            slv_reg_avg1        <= 32'd0;
            slv_reg_profit0     <= 32'd0; // NEW
            slv_reg_profit1     <= 32'd0; // NEW
            ...
            if (axi_awready && axi_wready && ~axi_bvalid) begin
                ...
                case(aw_idx)
                    ...
                    3082: slv_reg_avg1          <= S_AXI_WDATA; // FIXED: Changed 3081 to 3082
                    3083: slv_reg_profit0       <= S_AXI_WDATA; // NEW
                    3084: slv_reg_profit1       <= S_AXI_WDATA; // NEW
                endcase
             end
