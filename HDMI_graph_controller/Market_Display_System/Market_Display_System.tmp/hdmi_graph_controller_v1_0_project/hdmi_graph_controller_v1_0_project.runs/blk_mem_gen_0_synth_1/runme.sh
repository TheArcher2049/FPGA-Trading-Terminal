...
HD_PWD='d:/ece_385/final_project/market_display_system/market_display_system.tmp/hdmi_graph_controller_v1_0_project/hdmi_graph_controller_v1_0_project.runs/blk_mem_gen_0_synth_1'
cd "$HD_PWD"
